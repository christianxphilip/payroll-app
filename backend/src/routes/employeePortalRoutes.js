    ...
    const result = paidPayRuns
      ...
      .map(pr => {
        ...
        return {
          ...
          overtimePay,
          ndPay: nightDiffPay,
          regularHolidayHours: entry.regularHolidayHours || 0,
          regularHolidayPay,
          specialHolidayHours: entry.specialHolidayHours || 0,
          specialHolidayPay,
          overtimeRegularHolidayHours: entry.overtimeRegularHolidayHours || 0,
